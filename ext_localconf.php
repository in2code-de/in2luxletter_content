<?php
if (!is_array($GLOBALS['TYPO3_CONF_VARS']['SYS']['caching']['cacheConfigurations']['in2luxlettercontent_bodytext'])) {
    $GLOBALS['TYPO3_CONF_VARS']['SYS']['caching']['cacheConfigurations']['in2luxlettercontent_bodytext'] = [
        'groups' => ['pages']
    ];
}
